...
if(empty($_SESSION['id'])):
    echo "<script type='text/javascript'>alert('Trebuie sa fi logat ca sa poti accesa aceasta pagina!!');
                ...
                echo "<div id='Populare' class='populare'>";
                    ...
                    echo "<table>";
                      ...
                      while($row=mysqli_fetch_array($result)){
                        ...
                        $rating=$row['Rating'];
                        $oras=$row['Oras'];
                        $TipHotel=$row['TipHotel'];
                        
                        if($oras == $oras_section && $row['TipHotel']=="Normal"){
